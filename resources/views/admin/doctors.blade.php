    ...
    <div class="main">
        <div class="topbar">
            ...
            <div class="topbar-right">
                <div class="search-wrapper">
                    <input id="searchInput" type="text" class="search-box" placeholder="Search doctors...">
        ...
        <div class="page-header">
            <div class="page-title reveal">
                ...
                <p>Manage and track all hospital doctors</p>
            </div>
        ...
        <div class="card-table reveal">
            <x-table-filters
                :action="route('admin.doctors')"
                :type-options="[]"
                :status-options="['Available' => 'Available', 'Busy' => 'Busy']"
                :show-type="false" />
            <table class="table custom-table align-middle">
                ...
                <tbody id="doctorsTableBody">
                    ...
                    <tr>
                        ...
                        <td>{{ $doctor->department?->name_en ?? '-' }}</td>
                        <td>{{ $doctor->experience ? $doctor->experience . ' years' : '-' }}</td>
                        <td>{{ $doctor->email ?? '-' }}</td>
                        <td>{{ $doctor->privateClinic?->clinic_name ?? 'Not configured' }}</td>
                        ...
                        <td class="actions-cell">
                            <a href="{{ route('admin.doctors.schedule', $doctor->id) }}" class="action-link" title="Schedule">
                            ...
                            <form action="{{ route('admin.doctors.delete', $doctor->id) }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="action-btn" onclick="return confirm('Delete doctor #{{ $doctor->id }} only? Related records will be preserved by database safeguards.')">

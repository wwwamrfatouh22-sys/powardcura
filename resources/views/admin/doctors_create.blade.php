...
<head>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .department-option small { display: block; color: #6b7280; }
    .btn-save {
...
<body>
    <div class="card-form">
        ...
        <div class="subtitle">Create a doctor record that is saved immediately to the admin list.</div>
        ...
        <form action="{{ route('admin.doctors.store') }}" method="POST">
            @csrf
            @php($clinicDays = old('clinic_available_days', []))
            ...
            <div class="subtitle" style="margin-bottom:18px;">Private Clinic is enabled by default. Turn it off only for doctors who should not offer it.</div>

            <div class="mb-custom">
                <label class="d-inline-flex align-items-center gap-2">
                    <input type="hidden" name="has_private_clinic" value="0">
                    <input type="checkbox" name="has_private_clinic" value="1" {{ old('has_private_clinic', '1') === '1' ? 'checked' : '' }}>
            ...
            <div class="two-cols">
                <div class="mb-custom">
                    ...
                    <input type="text" name="clinic_phone" value="{{ old('clinic_phone') }}"
                ...
                <div class="mb-custom">
                    ...
                    <input type="number" step="0.01" min="0" name="clinic_fee" value="{{ old('clinic_fee') }}"
            ...
            <div class="mb-custom">
                ...
                <input type="text" name="clinic_available_times" value="{{ old('clinic_available_times') }}"
            ...
            <div class="mb-custom">
                ...
                <textarea name="clinic_notes" class="form-control @error('clinic_notes') is-invalid @enderror" placeholder="Optional notes for patients">{{ old('clinic_notes') }}</textarea>

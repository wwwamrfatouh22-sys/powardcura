        ...
        <div class="topbar">
            ...
            <div class="topbar-right">
                <div class="search-wrapper">
                    <input id="searchInput" type="text" class="search-box" placeholder="Search patients...">
            ...
            <table class="table custom-table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $patient->gender ? ucfirst(strtolower($patient->gender)) : '-' }}</td>
                        <td>{{ $patient->phone }}</td>
                        <td>{{ $patient->medical_condition }}</td>
                        <td>{{ $patient->last_visit }}</td>
                        <td class="actions-cell">
                            <a href="{{ route('admin.patients.edit', $patient->id) }}" class="action-link">
                            ...
                            <form action="{{ route('admin.patients.delete', $patient->id) }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="action-btn" onclick="return confirm('Delete patient #{{ $patient->id }} only?')">

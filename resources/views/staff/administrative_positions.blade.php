...
<head>
    <meta charset="UTF-8">
    <title>Administrative Positions Management</title>
...
<div class="sidebar" id="sidebar">
    ...
    <div class="menu-links">
        ...
        <a href="{{ route('staff.administrative.positions') }}" class="active-link">
...
<div class="header-section">
    ...
    <div class="page-title">
        ...
        <h2>Administrative Positions Management</h2>
        <p>Manage and track all administrative Positions</p>
